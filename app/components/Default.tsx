...
const Default = () => {
    return (
        <div className="max-w-4xl mx-auto px-6" id="container">
            <img src="/images/social.jpg" alt="Jeff Novello is a con man" className="w-full" />
            <div className="py-2 mb-2">
                <h1 className="text-xl font-bold uppercase hidden">
                    Jeff Novello is a Con Man
                </h1>

                <p className="text-lg">Jeff Novello, of Executive Business Solutions, and Mailfly inc., is a con man who has defrauded my family out of our retirement money.</p>
            </div>
                
            <hr className="my-4" />
            <h2 className="text-lg font-bold uppercase">These are 2 of his fraudulent businesses:</h2>
            <ul className="mb-4">
                <li className="italic"><a href="https://www.ripoffreport.com/reports/specific_search/jeff%20novello" target="_blank" rel="noopener">Executive Business Solutions</a></li>
                <li className="italic"><a href="https://www.bizapedia.com/people/jeff-novello.html" target="_blank" rel="noopener">Mailfly Creations</a></li>
            </ul>
            {/* <h3>He also owns:</h3> */}
            {/* <ul>
            <li className="italic"><a href="https://www.bizapedia.com/az/the-dance-hub-llc.html" target="_blank" rel="noopener">The Dance Hub</a></li>
            </ul> */}
            <h2 className="text-lg font-bold uppercase">Here&apos;s how his scam worked:</h2>
            ...
            <h3 className="text-lg font-bold uppercase">What to do if you&apos;ve been scammed by Jeff Novello</h3>
            <p className="mb-2">It is important that you contact the authorities to get a record of how Jeff Novello has defrauded you. Even if your money cannot be recovered, this will put his name on their radar. The courts will also look poorly upon him in a civil suit if there are pending FBI complaints against him.</p> 
            <ul className="list-disc ps-4 mb-4">
            ...
            <div className="mb-6">
                <h3 className="text-lg font-bold">Questions/Comments?</h3>
                <form name="contact" method="POST" data-netlify="true">
                    <div className="flex flex-col mb-2">
                        <label htmlFor="name">Your Name</label>
                        <input type="text" className="border rounded p-1" id="name" name="name" required />
                    </div>
                    <div className="flex flex-col mb-2">
                        <label htmlFor="email">Your Email address</label>
                        <input type="email" className="border rounded p-1" id="email" name="email" required />
                    </div>
                    <div className="flex flex-col mb-2">
                        <label htmlFor="comment">Your question/comment</label>
                        <textarea className="border rounded p-1" id="comment" rows={3} name="comment" required></textarea>
                    </div>
                    <button type="submit" className="px-6 py-2 bg-blue-500 rounded font-bold">Submit</button>
                </form>
            </div>
        </div>
    );
